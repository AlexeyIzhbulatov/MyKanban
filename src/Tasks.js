...
function Tasks(props) {
    ...
    return (
        <div className="taski">
            ...
            <span onClick={() => props.updateArrowStatus({id: props.task.id, direction: 'left'})}>{left}</span>
            <span onClick={() => props.updateArrowStatus({id: props.task.id, direction: 'right'})}>{right}</span>
            <span onClick={() => props.updateArrowStatus({id: props.task.id, direction: 'up'})}>{up}</span
